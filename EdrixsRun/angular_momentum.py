...
# Test-Enviroment for the wavefunction-test
#
if __name__ == '__main__':
    print(get_orb_momentum(l=1, ispin=True))
    #print(np.dot(get_spin_momentum(l=0),get_orb_momentum(l=0)))
    #print(get_spin_momentum(l=1))
    #print(get_spin_momentum(l=2))
